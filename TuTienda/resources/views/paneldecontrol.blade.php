...
<div style="width: 100%; position: fixed; z-index: 9999999;">
    <div style="text-align: center; background-color: #ffa500; width: 100%;">
    ...
    <div style="background: #ffa500; height: 100%; margin: 0;">
        <br>
        <br>
        <br>
        <br>
        <div class="container" style="margin-top: 0%;" style="text-align: center;">
            <div class="card bg-light mb-auto">
                <article class="card-body mx-auto" style="max-width: 1000px; display: inline; text-align: center">
                    ...
                    <div style="text-align: center">
                        ...
                        <a class="navbar-brand" href="{{ url('/verprod') }}" target="miiframe" style=" font-size: large;">Pedidos</a>
...
<br>
        ...
        <div style="text-align: center; background: #ffa500;">
            <br>
