...
$prods = DB::table('productos')->where('emailVendedor', $mail)->pluck('nombre');
...
<form enctype="multipart/form-data" action="{{ route('verController') }}" method="POST"> @csrf
    <article class="card-body mx-auto" style="max-width: 1000px; margin-top: -3%;">
        <h4 class="card-title mt-3 text-center">Mis Productos</h4>
