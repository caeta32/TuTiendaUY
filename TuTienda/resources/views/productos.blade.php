...
<br>
    <div>
        ...
        <ul class="list-group list-group-flush" style=" margin-left: 1%; width: 11%; margin-top: 2%; position: absolute">
            <a href="{{ url('proddesc')}}" target="_parent" class="list-group-item list-group-item-action">Mayor Precio</a>
            <a href="{{ url('prodasc') }}" target="_parent" class="list-group-item list-group-item-action">Menor Precio</a>
            <a href="{{ url('proddescfec') }}" target="_parent" class="list-group-item list-group-item-action">Mas Reciente</a>
            <a href="{{ url('prodascfec') }}" target="_parent" class="list-group-item list-group-item-action">Menos Reciente</a>
        </ul>
    </div>
    <div>
