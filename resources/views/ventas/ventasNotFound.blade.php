                ...
                <div class="row justify-content-center mb-5 mx-5 mt-5">
                    <div class="col">
                        <div class="row justify-content-center">
                            <h3>Aquí aparecerán los productos que vendas.</h3>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <hr>
                        ...
                        <div class="row justify-content-center text-center mt-4">
                            <p>¡Anímate a publicar productos, para que los demás puedan comprarte y llenes esta vista!</p>
                        </div>
                        <br>
                        <div class="row justify-content-center">
                            <div class="col-md-auto">
                                <a href="{{url('/vender')}}" target="_parent" class="btn btn-success" style="font-size: 17px;"><i class="fa fa-tag"></i> Vender</a>
                            </div>
                        </div>
                    </div>
                </div>
